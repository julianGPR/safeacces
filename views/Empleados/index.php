...
<head>
    ...
    <!-- Otros encabezados, estilos y scripts necesarios -->
...
<body>
    ...
    <div class="main-container">
        <div class="sidebar" id="sidebar">
            ...
            <a href="#" onclick="changeContent('calendario.php')"><i class="fas fa-calendar-alt"></i><span>Calendario</span></a>
        ...
        function changeContent(option) {
            ...
            switch(option) {
                ...
                case 'pdf':
                    ...
                    break;
                case 'calendario.php':  // Debe coincidir exactamente con el nombre del archivo
                    // Cargar calendario.php
                    content = `<object type="text/html" data="${option}" style="width:100%;height:100%;"></object>`;
                    break;
                case 'cerrar-sesion':
